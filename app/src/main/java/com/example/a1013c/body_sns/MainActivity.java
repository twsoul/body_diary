...
public class MainActivity extends AppCompatActivity {
    private static final String CLOUD_VISION_API_KEY = "AIzaSyA4sDqfPI0F9vceRHemXlA4q7Ua-io4dO0"; //키
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_vs);
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... params) {
            ...
            } catch (GoogleJsonResponseException e) { //여기 걸림
    ...
    private static String convertResponseToString(BatchAnnotateImagesResponse response) { //분석 결과
        final TextAnnotation text =response.getResponses().get(0).getFullTextAnnotation();

        return text.getText();


//        StringBuilder message = new StringBuilder("이미지 분석 결과:\n\n");
//
